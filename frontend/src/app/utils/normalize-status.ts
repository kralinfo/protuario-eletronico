 ...
 *
 * Este arquivo é a ÚNICA fonte de verdade para mapeamento de status no frontend.
 */
...
/**
 * Mapa de status canônico → label amigável para exibição na UI.
 */
...
/**
 * Retorna o label amigável para um status (normaliza antes).
 */
